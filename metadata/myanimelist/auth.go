...
func (p *MyAnimeList) Login(ctx context.Context, credentials metadata.CodeGrant) (metadata.User, metadata.AuthData, error) {
	return nil, metadata.AuthData{}, errors.ErrUnsupported
}
